...
const { getStorage, ref: storage_ref, getDownloadURL } = require("firebase/storage");
const { getDatabase, ref: database_ref, get, query: database_query, orderByChild, limitToLast, startAt, endBefore, limitToFirst, child, startAfter } = require("firebase/database");
const { getFirestore, collection, query: firestore_query, where, getDocs, doc, getDoc } = require("firebase/firestore");
...
module.exports = { fetchImage, fetchBlog, fetchPostList, fetchEvent, fetchDatabase, fetchStorageMultipleByPaths, fetchAllData };